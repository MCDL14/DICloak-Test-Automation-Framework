...
2. 当前 `tests/p0` 可发现 100 条 P0 用例：环境管理 43 条、全局设置 22 条、扩展管理 8 条、环境分组管理 6 条、成员分组管理 2 条、成员管理 15 条、代理管理 4 条。
...
当前第一阶段已完成环境管理模块 43 条 P0 用例，并已完成全局设置 22 条、扩展管理 8 条、环境分组管理 6 条、成员分组管理 2 条、成员管理 15 条和代理管理 4 条 P0 用例，共 100 条。最近一次完整 Windows P0 全量结果仍是 2026-07-01 的 62 条历史快照；当前 100 条不据此宣称全量通过。2026-08-27 新增“编辑扩展分组名称并恢复”单跑及扩展管理 8 条模块回归均通过，模块结果为 `total=8 passed=8 failed=0 errors=0 skipped=0 flaky=0`。2026-09-01 已兼容“创建代理”弹窗新增且默认选中的 PuraRoute 代理方式，代理管理 4 条模块回归全部通过。2026-09-02 已预留使用当前 APP 登录态通过接口创建环境的独立客户端，但尚未接入任何 P0；完整 P1 为 218 条。
