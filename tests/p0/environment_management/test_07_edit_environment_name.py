...
class TestEditEnvironmentName(unittest.TestCase):
    @classmethod
    ...
    def test_edit_environment_name_and_restore(self) -> None:
        ...
        try:
            ...
            environment_page.edit_environment_name_by_serial(original_serial, temporary_name)
            name_changed = True
            ...
            assert_equal(
                ...
                temporary_name,
                f"environment name was not changed by serial: serial={original_serial}",
            )

            environment_page.edit_environment_name_by_serial(original_serial, original_name)
            name_changed = False
            environment_page.wait_environment_name_by_serial(
                original_serial,
                original_name,
            ...
            assert_equal(
                environment_page.environment_name_by_serial(original_serial),
                original_name,
                f"environment name was not restored by serial: serial={original_serial}",
            )
        finally:
