...
CASE_MODULE = "环境管理"
ENVIRONMENT_NAME = "自动化-环境单独设置-cookie同步"
EXPECTED_LOGIN_STATUS = "已登录"
EXPECTED_ACCOUNT = "MCDL004"
EXPECTED_SYNC_ITEMS = ["Cookie"]
CREDENTIALS_DATA_KEY = "environment_new_cookie_persistence"


class TestIndividualEnvironmentCookieSync(unittest.TestCase):
    ...
    def test_individual_environment_cookie_sync_survives_close_reopen_and_local_cache_deletion(self) -> None:
            ...
            with KernelCDPSession(
                ...
                if login_username:
                    local_auth_page.login(
                        login_username,
                        login_password,
                        run_id="individual-environment-cookie-sync",
                    )
