...
CASE_MODULE = "环境管理"
ENVIRONMENT_NAME = "自动化-环境单独设置-IndexedDB同步"
...
class TestIndividualEnvironmentIndexedDBSync(unittest.TestCase):
    ...
    def test_individual_environment_indexeddb_sync_survives_close_reopen_and_local_cache_deletion(self) -> None:
            ...
            with KernelCDPSession(
                ...
                if login_username:
                    local_auth_page.login(
                        login_username,
                        login_password,
                        run_id="individual-environment-indexeddb-sync",
                    )
