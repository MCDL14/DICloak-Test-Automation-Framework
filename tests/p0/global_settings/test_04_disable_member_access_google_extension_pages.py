...
from core.kernel_cdp import verify_extension_pages_blocked
...
class TestDisableMemberAccessGoogleExtensionPages(unittest.TestCase):
    @classmethod
    ...
    def test_disable_member_access_google_extension_pages(self) -> None:
        ...
        try:
            ...
            result = verify_extension_pages_blocked(
            ...
            assert_true(
                result.webstore_blocked,
                "chrome web store page was not blocked as expected: "
                f"url={result.webstore_target_url}, evidence={result.webstore_evidence}",
            )
