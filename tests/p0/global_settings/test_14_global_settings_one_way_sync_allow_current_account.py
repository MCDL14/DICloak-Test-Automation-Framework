...
class TestGlobalSettingsOneWaySyncAllowCurrentAccount(unittest.TestCase):
    ...
    def test_global_settings_one_way_sync_allows_current_account_data_upload(self) -> None:
                ...
                for site in SITE_DEFINITIONS:
                    ...
                    if credentials_by_site:
                        ...
                        local_auth_page.login(
                            username,
                            password,
                            run_id=f"global-one-way-sync-allow-{site_id}",
                        )
                    ...
                    self.logger.info(
                        "Global one-way sync allow login status captured: "
